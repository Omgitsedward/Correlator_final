...
#	Correlators ue 10-point pfbs & ffts for 9-point spectra per input
...
#		quantized.py currently only takes in a single value '-c' to scale all 12 data lines at once
#		code would need to be changed to scale each individually should it be necessary
